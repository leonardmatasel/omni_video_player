...
import 'package:omni_video_player/src/_youtube/mobile/player_event_handler.dart';
...
class YoutubeMobilePlaybackController extends OmniPlaybackController {
  ...
  void _initJavaScriptHandlers() {
    ...
    webViewController?.addJavaScriptHandler(
      ...
      callback: (args) => _eventHandler.onStateChange(args.first),
    );
    webViewController?.addJavaScriptHandler(
    ...
    webViewController?.addJavaScriptHandler(
      ...
      callback: (args) => _eventHandler.onVideoState(args.first),
    );
  }
