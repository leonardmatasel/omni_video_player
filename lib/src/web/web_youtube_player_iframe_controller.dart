...
class WebYoutubePlayerIframeControllerCreationParams
  ...
  @visibleForTesting
  final IframeElement ytiFrame = IframeElement(id: _nextIFrameId++)
    ..credentialless = true;
}
...
extension type IframeElement._(HTMLIFrameElement element) {
  /// A class that represents a YouTube iframe element.
  IframeElement({required int id})
  ...
  /// The underlying [HTMLIFrameElement] used by the [IframeElement].
